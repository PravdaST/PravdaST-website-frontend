...
- June 25, 2025. Successfully created new Vercel-integrated Neon database with all tables (users, admin_sessions, blog_posts, contacts) and admin user (admin/pravda2025); updated all API endpoints to use DATABASE_DATABASE_URL environment variable; database setup completed and tested locally with successful connection and authentication
