...
- June 24, 2025. Restored original Pravdast homepage and moved CRM admin system to separate /admin page with secure login (admin/pravdast2025), dashboard overview, system status monitoring, and direct access without main site navigation/footer for clean admin experience
