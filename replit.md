...
- June 29, 2025. Fixed CTA section button design and messaging: changed button to black background with white text, updated hover animation to bounce (y: -8) instead of color change for consistency, removed repetitive "Безплатна консултация" text from trust indicators and description, replaced with more meaningful messaging about precise client selection and consultation process being a detailed evaluation rather than just a service
- June 29, 2025. Applied same CTA fixes to /services page: updated button design to black background with white text and bounce hover animation, removed repetitive "Безплатна консултация" and "Без ангажименти" from trust indicators, replaced with "Прецизна селекция на клиенти" and "100% поверителност", updated description text to match homepage messaging consistency
