...
- June 25, 2025. Fixed admin CRM system API endpoints by converting to proper ES modules format for Vercel serverless compatibility: login.js, logout.js, blog/posts.js, blog/[id].js, contacts.js - all using import statements and Neon HTTP client; admin system ready for production once DATABASE_URL environment variable is configured in Vercel
