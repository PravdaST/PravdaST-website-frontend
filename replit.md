...
- June 25, 2025. Completed admin CRM system setup with new Vercel-integrated Neon database: all tables created, admin user configured (admin/pravda2025), all API endpoints updated; final step requires manual addition of DATABASE_URL environment variable in Vercel Settings → Environment Variables with new database connection string
