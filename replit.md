...
- June 25, 2025. Successfully set up new Vercel-Neon database (ep-wandering-dawn-a2uzu8gm-pooler) with complete schema: users, admin_sessions, blog_posts, contacts tables created; admin user (admin/pravda2025) configured with bcrypt hash; all API endpoints updated to use DATABASE_DATABASE_URL fallback; ready for production deployment after environment variable configuration in Vercel
