...
import { TrendingUp, Clock, CircleHelp } from "lucide-react"
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {problems.map((problem, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="rounded-lg border text-card-foreground shadow-sm relative bg-slate-800/50 border-red-500/20 hover:border-red-500/50 transition-all duration-300 group overflow-hidden h-full">
                {/* Hover effect */}
                ...
                <div className="p-8 text-center relative z-10">
                  ...
                  <div className="relative mb-6">
                    ...
                    <motion.div
                      ...
                      animate={{ scale: [1, problem.scale, 1] }}
