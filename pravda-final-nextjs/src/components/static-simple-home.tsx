        ...
        <div className="absolute inset-0 opacity-15">
          <div className="absolute inset-0">
            ...
            <div className="tech-lines">
              <div className="absolute h-px bg-gradient-to-r from-transparent via-[#ECB629] to-transparent" style={{ top: '20%', width: '200px', left: '10%', right: 'auto', transform: 'scaleX(1.17337)' }}></div>
              <div className="absolute h-px bg-gradient-to-r from-transparent via-[#ECB629] to-transparent" style={{ top: '35%', width: '250px', left: 'auto', right: '10%', transform: 'scaleX(1.05601)' }}></div>
              <div className="absolute h-px bg-gradient-to-r from-transparent via-[#ECB629] to-transparent" style={{ top: '50%', width: '300px', left: '10%', right: 'auto', transform: 'scaleX(0.880105)' }}></div>
              <div className="absolute h-px bg-gradient-to-r from-transparent via-[#ECB629] to-transparent" style={{ top: '65%', width: '350px', left: 'auto', right: '10%', transform: 'scaleX(0.826633)' }}></div>
              <div className="absolute h-px bg-gradient-to-r from-transparent via-[#ECB629] to-transparent" style={{ top: '80%', width: '400px', left: '10%', right: 'auto', transform: 'scaleX(0.943985)' }}></div>
              <div className="absolute h-px bg-gradient-to-r from-transparent via-[#ECB629] to-transparent" style={{ top: '95%', width: '450px', left: 'auto', right: '10%', transform: 'scaleX(1.1199)' }}></div>
            </div>
            <div className="absolute w-1 h-1 bg-[#ECB629] rounded-full" style={{ left: '73.6156%', top: '46.4188%', transform: 'scale(1.28269)' }}></div>
            <div className="absolute w-1 h-1 bg-[#ECB629] rounded-full" style={{ left: '83.3216%', top: '22.9405%', transform: 'scale(1.22495)' }}></div>
            <div className="absolute w-1 h-1 bg-[#ECB629] rounded-full" style={{ left: '59.9797%', top: '68.0345%', transform: 'scale(1.08383)' }}></div>
            <div className="absolute w-1 h-1 bg-[#ECB629] rounded-full" style={{ left: '18.5343%', top: '81.2257%', transform: 'scale(1.26043)' }}></div>
            <div className="absolute w-1 h-1 bg-[#ECB629] rounded-full" style={{ left: '11.7245%', top: '74.7094%', transform: 'scale(1.04448)' }}></div>
            <div className="absolute w-1 h-1 bg-[#ECB629] rounded-full" style={{ left: '7.91195%', top: '25.8146%', transform: 'scale(1.00566)' }}></div>
            <div className="absolute w-1 h-1 bg-[#ECB629] rounded-full" style={{ left: '23.263%', top: '90.7202%', transform: 'scale(1.31293)' }}></div>
            <div className="absolute w-1 h-1 bg-[#ECB629] rounded-full" style={{ left: '68.4081%', top: '24.5754%', transform: 'scale(1.23371)' }}></div>
            <div className="absolute w-1 h-1 bg-[#ECB629] rounded-full" style={{ left: '85.3689%', top: '66.4324%', transform: 'scale(1.47779)' }}></div>
            <div className="absolute w-1 h-1 bg-[#ECB629] rounded-full" style={{ left: '45.998%', top: '29.8833%', transform: 'scale(1.0105)' }}></div>
            <div className="absolute w-1 h-1 bg-[#ECB629] rounded-full" style={{ left: '12.8586%', top: '32.6526%', transform: 'scale(1.11644)' }}></div>
            <div className="absolute w-1 h-1 bg-[#ECB629] rounded-full" style={{ left: '44.8438%', top: '57.1638%', transform: 'scale(1.18175)' }}></div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full mb-8 bg-gradient-to-r from-slate-800/80 to-slate-700/60 border border-[#ECB629]/20 backdrop-blur-sm" style={{ opacity: 1, transform: 'none' }}>
              <div className="relative">
                ...
                <div className="absolute inset-0 w-3 h-3 bg-green-400 rounded-full opacity-30" style={{ transform: 'scale(1.18238)' }}></div>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 gap-3 sm:gap-6 max-w-3xl mx-auto px-4 sm:px-0" style={{ opacity: 1, transform: 'none' }}>
              <div className="relative flex items-center justify-center gap-3 p-4 bg-gradient-to-r from-slate-800/50 to-slate-700/50 backdrop-blur-sm rounded-xl border border-[var(--pravdast-yellow)]/30 overflow-hidden group" style={{ borderColor: 'rgba(236, 182, 40, 0.32)' }}>
                ...
                <div className="absolute inset-0 bg-[var(--pravdast-yellow)]/5 rounded-xl" style={{ transform: 'scale(1.0456)' }}></div>
                <div className="relative">
                  <div className="w-2 h-2 bg-[var(--pravdast-yellow)] rounded-full relative z-10" style={{ transform: 'scale(1.07115)' }}></div>
                  <div className="absolute inset-0 w-2 h-2 bg-[var(--pravdast-yellow)] rounded-full" style={{ transform: 'scale(2.38576)' }}></div>
                </div>
