...
export const servicesMetadata: Metadata = {
  title: "Услуги - Pravda Agency | SEO, Съдържание, Реклами, CRM",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Pravda Agency - Бизнес инженерство системи'
      }
    ]
  },
  twitter: {
...
export const seoStruktorMetadata: Metadata = {
  title: "SEO Struktor™ - Pravda Agency | Система за онлайн доминация",
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://pravdagency.eu/pravda-og-seo.png',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['https://pravdagency.eu/pravda-og-seo.png']
  }
}
...
export const trendlabMetadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://pravdagency.eu/pravda-og-trendlab.png',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['https://pravdagency.eu/pravda-og-trendlab.png']
  }
}

export const clickstarterMetadata: Metadata = {
  title: "Clickstarter™ - Pravda Agency | Система за ускорен растеж",
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://pravdagency.eu/pravda-og-clickstarter.png',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['https://pravdagency.eu/pravda-og-clickstarter.png']
  }
}
...
export const clientomatMetadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://pravdagency.eu/pravda-og-clientomat.png',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['https://pravdagency.eu/pravda-og-clientomat.png']
  }
}
