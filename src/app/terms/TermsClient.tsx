              ...
              >
                <div className="prose prose-lg prose-invert max-w-none">
                  ...
                  <p className="text-gray-300 mb-6">
                    Първо, представянето: аз съм Стефан от Pravdast Agency и помагам на фирми да растат системно. 
                    Ако използваш някоя от <Link href="/services" className="text-yellow-400 hover:text-yellow-300 underline">услугите ми</Link>, 
                    това означава че приемаш правилата тук долу.
                  </p>
                  <p className="text-gray-300 mb-8">
                    Няма скрито писмо. Всичко е тук. За това как пазя данните ти, прочети 
                    <Link href="/privacy" className="text-yellow-400 hover:text-yellow-300 underline"> политиката за поверителност</Link>.
                    А ако искаш да <Link href="/about" className="text-yellow-400 hover:text-yellow-300 underline">научиш повече за мен</Link> - и това е там.
                  </p>

                  <h2 className="text-3xl font-bold text-white mb-6">2. Какво правя за теб?</h2>
                  <p className="text-gray-300 mb-4">Имам 4 основни системи, които помагат на фирмите да растат:</p>
                  ...
                  <h2 className="text-3xl font-bold text-white mb-6">3. Какво правя аз?</h2>
                  <ul className="text-gray-300 mb-8 space-y-2">
                    <li>• Свършвам работата в договорения срок (не обещавам невъзможно)</li>
                    <li>• Правя всичко качествено - не съм от евтините, но съм от добрите</li>
                    <li>• Всеки месец ти казвам какво съм направил и какви са резултатите</li>
                    <li>• Не споделям бизнес информацията ти с никого</li>
                    <li>• Отговарям на въпросите ти и поправям ако нещо се счупи</li>
                  </ul>

                  <h2 className="text-3xl font-bold text-white mb-6">4. Какво очаквам от теб?</h2>
                  <ul className="text-gray-300 mb-8 space-y-2">
                    <li>• Да ми дадеш информацията, от която се нуждая за работата</li>
                    <li>• Да плащаш в срок (без това не мога да работя)</li>
                    <li>• Да ми дадеш достъп до сайта/Facebook/където трябва да работя</li>
                    <li>• Да си отзивчив когато имам въпроси</li>
                    <li>• Да ме информираш ако нещо се промени в бизнеса</li>
                  </ul>
                  ...
                  <ul className="text-gray-300 mb-8 space-y-2">
                    ...
                    <li>• Работя само в лева - не се занимавам с валута</li>
                    <li>• Ако закъснееш с плащането, ще има лихва 0.1% на ден (не е лично, просто трябва)</li>
                    <li>• Цените са без ДДС - ще го добавя в фактурата</li>
                  </ul>
                  ...
                  <ul className="text-gray-300 mb-8 space-y-2">
                    ...
                    <li>• Ако си платил за работа, която още не съм свършил - връщам парите</li>
                    <li>• Работата, която съм направил, остава моя докато не се разплатим</li>
                  </ul>

                  <h2 className="text-3xl font-bold text-white mb-6">7. За отговорностите</h2>
                  <ul className="text-gray-300 mb-8 space-y-2">
                    <li>• Не отговарям за неща извън контрола ми (Google алгоритми, кризи, вируси...)</li>
                    <li>• Гарантирам работата си 3 месеца - ако се счупи нещо, поправям го</li>
                    <li>• Не мога да ти гарантирам колко точно пари ще направиш (никой не може)</li>
                    <li>• Ако стане някаква беля, максимум ще ти върна колкото си ми платил</li>
                  </ul>

                  <h2 className="text-3xl font-bold text-white mb-6">8. За тайните</h2>
                  <ul className="text-gray-300 mb-8 space-y-2">
                    <li>• Не споделям информацията за твоя бизнес с никого</li>
                    <li>• Ти също не споделяш моите методи с конкуренцията</li>
                    <li>• Това важи дори и след като спрем да работим заедно</li>
                    <li>• Изключение е само ако някой съд ме задължи или ти ми дадеш разрешение</li>
                  </ul>
                  ...
                  <p className="text-gray-300 mb-8">
                    ...
                    (Надявам се никога да не стигнем дотам - предпочитам да си говорим като хора!)
                    А ако искаш да видиш как работя с други клиенти, виж <Link href="/case-studies" className="text-yellow-400 hover:text-yellow-300 underline">резултатите тук</Link>.
                  </p>

                  <h2 className="text-3xl font-bold text-white mb-6">10. Как да ме намериш</h2>
                  <div className="text-gray-300 space-y-2">
                    <p><strong>Правдаст (Стефан Генов)</strong></p>
                    ...
                    <p className="text-sm mt-4 text-gray-400 italic">
                      (Отговарям всеки ден освен неделя - тогава си почивам с фамилията)
                    </p>
                  </div>
                </div>
              </motion.div>
