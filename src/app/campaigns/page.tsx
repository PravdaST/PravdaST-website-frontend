...
export const metadata: Metadata = {
  title: 'Готови решения | Спри да търсиш маркетинг агенции',
  description: 'Спри да търсиш маркетинг агенции. Ето готови бизнес решения които работят - не теории, а системи за реални продажби.',
  keywords: 'готови решения, спри маркетинг агенции, бизнес системи, реални продажби, pravda софия, не теории',
  openGraph: {
