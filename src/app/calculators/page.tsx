      ...
      <main className="pt-20">
        <div className="container mx-auto px-4 py-20">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-white mb-8">ROI Калкулатори</h1>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
                <h3 className="text-xl font-semibold text-white mb-4">SEO Struktor™</h3>
                <p className="text-gray-400">SEO оптимизация и растеж</p>
              </div>
              
              <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
                <h3 className="text-xl font-semibold text-white mb-4">Trendlab™</h3>
                <p className="text-gray-400">Съдържание и авторитет</p>
              </div>
              
              <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
                <h3 className="text-xl font-semibold text-white mb-4">Clickstarter™</h3>
                <p className="text-gray-400">Реклами и конверсии</p>
              </div>
              
              <div className="bg-slate-800 p-6 rounded-xl border border-slate-700">
                <h3 className="text-xl font-semibold text-white mb-4">Clientomat™</h3>
