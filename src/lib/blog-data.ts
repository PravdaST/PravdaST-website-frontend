...
export const blogPosts: BlogPost[] = [
  {
    id: "6",
    title: "Защо работата с бизнес инженери е по-добрата алтернатива от изграждането и поддържането на маркетинг екип",
    ...
    content: `# Защо вашият вътрешен екип тайно изгаря капитал (и какво да направите по въпроса)
...
## Clientomat™: Затварянето на цикъла
...
Нашето решение се казва **Clientomat™** – автоматизирана система за превръщане на запитвания в клиенти. Тя работи денонощно, без почивки, без болнични, без заплати.
...
| **Връщаемост** | Неясна, непредвидима | Измерима, гарантирана |
| **Риск** | Висок (зависи от хора) | Нисък (системен подход) |
| **Мащабируемост** | Линейна (повече хора = повече разходи) | Експоненциална (системите се подобряват) |
...
Първата стъпка във всеки инженерен проект е диагностиката. Ако сте готови да видите каква е реалната цена на хаоса във вашата фирма и какъв е потенциалът за системен растеж, ние сме на разположение.`,
    ...
    tags: ["бизнес инженерство", "маркетинг екип", "растеж", "ROI", "автоматизация", "системи"]
  },
  {
    id: "1",
