...
export const pageSEOData: Record<string, Partial<SEOData>> = {
  ...
  about: {
    title: "За Нас - Pravdast | Експерти в Бизнес Инженеринг от 2020г | България",
  ...
  services: {
    title: "Услуги - Pravdast | SEO, Продажби, Автоматизация | България 2025",
  ...
  "services/seo-struktor": {
    title: "SEO Struktor™ - Професионална SEO Система | Технически SEO България",
  ...
  "services/sales-engine": {
    title: "Sales Engine™ - Автоматизирана B2B Продажбена Система | CRM България",
  ...
  "services/clientomat": {
    title: "Clientomat™ - Автоматизирана Клиентска Система | Lead Generation България",
  ...
  "case-studies": {
    title: "Казуси - Pravdast | Успешни B2B Проекти и Резултати | България",
  ...
  contact: {
    title: "Контакти - Pravdast | Безплатна Консултация за Бизнес Растеж | България",
