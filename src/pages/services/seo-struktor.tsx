      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Вашите SEMENA конкуренти не са по-добри.{" "}
                ...
                <div className="relative p-8 bg-slate-700/50 rounded-lg border border-red-500/30">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-300">
                      ...
                      страница тук, пише се статия там. Липсва единна, централна
                      структура. Точно това е причината резултатите да са
                      непредсказуеми и краткотрайни.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="relative p-8 bg-slate-700/50 rounded-lg border border-[var(--pravdast-yellow)]/30">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-300">
                      ...
                      цялостния инженерен план (SEO Struktor™), който
                      гарантира, че всеки елемент работи в синхрон с останалите,
                      за да се постигне крайната цел - доминация в Google.
                    </p>
                  </div>
                </div>
              </div>
                ...
                {[
                  ...
                  >
                    ...
                    <div className="flex-1 bg-slate-800/50 p-6 rounded-lg border border-slate-700">
                      <div className="mb-2">
                        <span className="text-sm text-[var(--pravdast-yellow)] font-semibold">
                          {item.phase}
                        </span>
                      </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "и разпознаваемост на вашия бранд като експерт в нишата.",
              },
            ].map((item, index) => (
              <motion.div
                key={index}
        ...
        <div className="absolute inset-0 opacity-5">
          <div className="grid grid-cols-12 gap-4 h-full">
            {Array.from({ length: 120 }).map((_, i) => (
              <div
                key={i}
                className="border-l border-[var(--pravdast-yellow)]"
              ></div>
            ))}
          </div>
        </div>
            ...
            <div className="space-y-8">
              <div className="bg-slate-800/50 p-8 rounded-lg border border-slate-700">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Всяка система SEO Struktor™ се проектира и изгражда спрямо
                  уникалните цели и състояние на вашия бизнес. Ние не предлагаме
                  готови пакети.
                </p>
              </div>
              ...
              <div className="bg-slate-800/50 p-8 rounded-lg border border-slate-700">
                ...
                <p className="text-gray-300 leading-relaxed">
                  За ориентация, базовите инженерни проекти започват от{" "}
              ...
              <div className="bg-slate-800/50 p-8 rounded-lg border border-slate-700">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Финалната инвестиция се определя след задължителна техническа
                  диагностика. Вие получавате детайлно инженерно предложение, в
                  което всеки компонент е ясно описан и стойностен.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="max-w-3xl mx-auto space-y-6">
              <p className="text-lg text-gray-300 leading-relaxed">
                Нашият инженерен процес е задълбочен и изисква пълна отдаденост.
                Затова работим с{" "}
                <span className="text-white font-semibold">
                  ограничен брой нови клиенти всеки месец
                </span>
                , за да гарантираме качество и реални резултати.
              </p>

              <p className="text-lg text-gray-300 leading-relaxed">
                Първата стъпка е нашата експертна диагностика. С нейна помощ ще
                научите повече за скритите проблеми на вашия сайт, отколкото
                повечето агенции могат да ви кажат след месеци работа.
              </p>
            </div>
