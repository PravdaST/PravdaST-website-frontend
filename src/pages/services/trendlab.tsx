              ...
              <div className="space-y-16">
                {[
                  ...
                  >
                    ...
                    {/* Content Card */}
                    <div
                      className={`w-full ${phase.position === "left" ? "pr-16" : "pl-16"}`}
                    >
                      <Card
                        className={`bg-slate-800/40 border-slate-600/30 p-6 backdrop-blur-sm hover:bg-slate-800/60 transition-all duration-300 group relative overflow-hidden ${
                          phase.position === "left"
                            ? "ml-0 mr-auto"
                            : "ml-auto mr-0"
                        } max-w-md`}
                      >
                        ...
                        <div className="relative z-10">
                          ...
                          <div className="space-y-3">
                            <div className="bg-slate-700/30 rounded-lg p-3 border border-slate-600/20">
                              <div className="text-xs text-[#ECB629] font-semibold mb-1">
                                ВРЕМЕТРАЕНЕ
                              </div>
                        ...
                        <div
                          className={`absolute top-1/2 transform -translate-y-1/2 w-8 h-px bg-[#ECB629]/50 ${
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">
                Ограничена наличност • Работим с{" "}
                <span className="font-bold">максимум 8 клиента</span> месечно
              </span>
            </motion.div>
            ...
            <div className="max-w-3xl mx-auto mb-12">
              <p className="text-xl mb-6 leading-relaxed">
                Нашата експертна диагностика ще анализира вашия настоящ
                авторитет и ще ви даде ясен инженерен план как да се превърнете
                в лидер на мнение във вашата сфера.
              </p>
