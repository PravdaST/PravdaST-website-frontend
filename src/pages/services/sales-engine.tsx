      ...
      <section className="pt-24 pb-16 bg-gradient-to-br from-[var(--pravdast-dark)] to-[var(--pravdast-dark-gray)] relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-12">
            <div className="absolute inset-0 bg-[repeating-linear-gradient(90deg,transparent,transparent_19px,var(--pravdast-yellow)/8_20px,var(--pravdast-yellow)/8_21px,transparent_22px,transparent_40px)]"></div>
          </div>
          ...
          {/* Processing nodes at each stage */}
          <motion.div
            className="absolute top-1/4 left-1/6 w-10 h-10 border border-[var(--pravdast-yellow)]/60 rounded-lg -translate-x-1/2 -translate-y-1/2 bg-[var(--pravdast-yellow)]/5"
            animate={{ 
              scale: [1, 1.1, 1],
              opacity: [0.6, 1, 0.6],
          ...
          />
          <motion.div
            className="absolute top-3/4 left-3/6 w-12 h-12 border-2 border-[var(--pravdast-yellow)]/70 rounded-lg -translate-x-1/2 -translate-y-1/2 bg-[var(--pravdast-yellow)]/8"
            animate={{ 
              scale: [1, 1.05, 1],
              opacity: [0.7, 1, 0.7],
              borderColor: ["rgba(236, 182, 40, 0.7)", "rgba(236, 182, 40, 1)", "rgba(236, 182, 40, 0.7)"]
            }}
            transition={{
              duration: 3,
              repeat: Infinity,
          ...
          <motion.div
            className="absolute top-1/4 left-1/6 w-16 h-0.5 bg-gradient-to-r from-[var(--pravdast-yellow)]/80 to-transparent"
            animate={{ 
              scaleX: [0, 1, 0],
              opacity: [0, 1, 0]
            }}
          ...
          />
          <motion.div
            className="absolute top-2/4 left-2/6 w-14 h-0.5 bg-gradient-to-r from-[var(--pravdast-yellow)]/80 to-transparent"
            animate={{ 
              scaleX: [0, 1, 0],
              opacity: [0, 1, 0]
            }}
          ...
          />
          <motion.div
            className="absolute top-3/4 left-3/6 w-18 h-0.5 bg-gradient-to-r from-[var(--pravdast-yellow)]/80 to-transparent"
            animate={{ 
              scaleX: [0, 1, 0],
              opacity: [0, 1, 0]
            }}
          ...
          />
          <motion.div
            className="absolute top-1/3 left-4/6 w-12 h-0.5 bg-gradient-to-r from-[var(--pravdast-yellow)]/80 to-transparent"
            animate={{ 
              scaleX: [0, 1, 0],
              opacity: [0, 1, 0]
            }}
          ...
          <motion.div
            className="absolute bottom-1/4 right-1/6 w-24 h-2 bg-gradient-to-r from-transparent via-[var(--pravdast-yellow)]/60 to-[var(--pravdast-yellow)]/20 rounded-full"
            animate={{ 
              scaleX: [0.3, 1, 0.3],
              opacity: [0.6, 1, 0.6]
            }}
          ...
          {/* Lead processing particles flowing through pipeline */}
          <motion.div
            className="absolute top-1/5 left-0 w-1.5 h-1.5 bg-[var(--pravdast-yellow)] rounded-full"
            animate={{ 
              x: [0, 200, 400, 600, 800],
              y: [0, 5, -5, 10, 20],
              opacity: [0, 1, 1, 1, 0]
          ...
          />
          <motion.div
            className="absolute top-2/5 left-0 w-1 h-1 bg-[var(--pravdast-yellow)] rounded-full"
            animate={{ 
              x: [0, 180, 360, 540, 720],
              y: [0, -8, 3, -3, 8],
              opacity: [0, 1, 1, 1, 0]
          ...
          />
          <motion.div
            className="absolute top-3/5 left-0 w-1.5 h-1.5 bg-[var(--pravdast-yellow)] rounded-full"
            animate={{ 
              x: [0, 220, 440, 660, 880],
              y: [0, 8, -8, 5, -5],
              opacity: [0, 1, 1, 1, 0]
