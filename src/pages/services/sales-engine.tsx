...
const features = [
  {
    ...
    description:
      "Системата работи 24/7 за да привлича квалифицирани потенциални клиенти към бизнеса ви.",
  },
  {
    icon: Filter,
    title: "Оптимизирана продажбена фуния",
    description:
      "Всяка стъпка от процеса е проектирана да максимизира конверсиите.",
  },
  {
    icon: BarChart,
    title: "Предвидими резултати",
    description:
      "Точно знаете колко лийдове и продажби да очаквате всеки месец.",
  },
];
...
const process = [
  {
    ...
    description:
      "Определяме точно кой е идеалният ви клиент и къде се намира онлайн.",
  },
  {
    step: "02",
    title: "Създаване на магнити за лийдове",
    description:
      "Разработваме стойностни предложения, които привличат квалифицирани потенциални клиенти.",
  },
  {
    step: "03",
    title: "Автоматизирана продажбена фуния",
    description:
      "Изграждаме система, която автоматично насочва лийдовете към покупка.",
  },
  {
    step: "04",
    title: "Оптимизация и скалиране",
    description:
      "Постоянно подобряваме резултатите и увеличаваме обема на генерираните продажби.",
  },
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-[var(--pravdast-dark)] to-[var(--pravdast-dark-gray)] text-white">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Двойна система за B2B растеж.
              <br />
              <span className="text-[var(--pravdast-yellow)]">
                Trend анализ + Click генериране = Предвидим резултат.
              </span>
            </motion.p>
            ...
            >
              ...
              <Button
                ...
                asChild
              >
                <a href="#process">Вижте процеса</a>
              </Button>
            </motion.div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-4xl font-bold mb-6">
              Чакате ли клиентите да ви намерят?
            </h2>
            <p className="text-xl text-gray-300">
              Повечето компании разчитат на случайни контакти вместо да имат
              система за постоянен поток от клиенти
            </p>
          </div>
      ...
      <section className="py-20 bg-[var(--pravdast-dark-gray)]">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-4xl font-bold mb-6">
              Sales Engine™ ви дава{" "}
              <span className="text-[var(--pravdast-yellow)]">контрол</span>
            </h2>
            <p className="text-xl text-gray-300">
              Вместо да чакате, получавате постоянен поток от квалифицирани
              лийдове и продажби
            </p>
          </div>
                ...
                <Card className="bg-[var(--pravdast-dark)] border-[var(--pravdast-yellow)] h-full">
                  <CardContent className="p-8 text-center">
                    <div className="w-16 h-16 mx-auto mb-6 bg-[var(--pravdast-yellow)]/10 rounded-full flex items-center justify-center">
                      <feature.icon
                        className="text-[var(--pravdast-yellow)]"
                        size={32}
                      />
                    </div>
                  ...
                  <CardContent className="p-8">
                    <div className="flex items-start space-x-4">
                      <div className="w-12 h-12 bg-[var(--pravdast-yellow)] rounded-full flex items-center justify-center flex-shrink-0">
                        <span className="font-bold text-[var(--pravdast-dark)]">
                          {step.step}
                        </span>
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-left">
                        {[
                          ...
                          >
                            <CheckCircle
                              className="text-[var(--pravdast-yellow)] flex-shrink-0"
                              size={16}
                            />
