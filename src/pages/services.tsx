  ...
  return (
    <div className="absolute inset-0 overflow-hidden opacity-15">
      ...
      <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="systems-grid" width="80" height="80" patternUnits="userSpaceOnUse">
            <path d="M 80 0 L 0 0 0 80" fill="none" stroke="#ECB629" strokeWidth="0.5" opacity="0.3"/>
      ...
      {['SYSTEMS', 'ENGINEERING', 'GROWTH', 'AUTOMATION', 'RESULTS', 'SCALE'].map((keyword, i) => (
        <motion.div
          key={keyword}
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              >
                Спрете да залагате на късмет. Изграждаме системи, които работят предвидимо и носят измерими резултати за вашия бизнес.
              </motion.p>
              ...
              >
                ...
                <div className="flex items-center justify-center gap-3 p-4 bg-slate-800/30 backdrop-blur-sm rounded-xl border border-slate-600/20">
                  <div className="w-2 h-2 bg-[#ECB629] rounded-full"></div>
                  <span className="text-gray-300 text-sm font-medium">Измерими резултати</span>
                </div>
                <div className="flex items-center justify-center gap-3 p-4 bg-slate-800/30 backdrop-blur-sm rounded-xl border border-slate-600/20">
                  <div className="w-2 h-2 bg-[#ECB629] rounded-full"></div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-8">
              ...
              <span className="text-[#ECB629]">Започнете да изграждате системи.</span>
            </h2>
          </motion.div>
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                  <div className="mb-6">
                    ...
                    <h3 className="text-xl font-bold text-red-300 mb-3">Залагане на късмет</h3>
                  </div>
                ...
                >
                  <div className="mb-6">
                    ...
                    <h3 className="text-xl font-bold text-[#ECB629] mb-3">Инженерни системи</h3>
                  </div>
                  ...
                  <CardContent className="p-8 relative z-10 h-full flex flex-col">
                    ...
                    <div className="flex items-center gap-4 mb-6">
                      <div className="relative">
                        <div className="w-16 h-16 bg-[#ECB629]/20 rounded-full flex items-center justify-center border border-[#ECB629]/30 group-hover:bg-[#ECB629]/30 transition-all duration-300">
                          <service.icon className="text-[#ECB629] group-hover:scale-110 transition-transform duration-300" size={32} />
                        </div>
                        <motion.div
                    ...
                    <div className="grid gap-3 mb-6">
                      {service.benefits.map((benefit, benefitIndex) => (
                        ...
                        >
                          <CheckCircle className="text-[#ECB629] flex-shrink-0" size={16} />
                      ...
                      <Link href={`/services/${service.slug}`}>
                        ...
                        >
                          <span className="relative z-10 flex items-center justify-center gap-2">
                            Научете повече
                            <service.icon size={18} className="group-hover/btn:scale-110 transition-transform duration-300" />
                          </span>
