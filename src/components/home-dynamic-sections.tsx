...
// Dynamic imports for heavy components below fold - Client Component needed for ssr: false
const CaseStudiesNew = dynamic(() => import('@/components/case-studies-new'), {
  ssr: false,
...
const CaseStudiesSlider = dynamic(() => import('@/components/case-studies-slider').then(mod => ({ default: mod.CaseStudiesSlider })), {
  ssr: false,
