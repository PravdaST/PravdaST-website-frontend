  ...
  faq: {
    ...
    structuredData: {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Какво е бизнес инженеринг?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Бизнес инженерингът е системен подход към изграждане на предсказуеми и мащабируеми бизнес процеси. Вместо да разчитаме на късмет, създаваме структурирани системи за постигане на конкретни резултати."
          }
        },
        {
          "@type": "Question",
          "name": "За какви компании са подходящи вашите услуги?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Работим основно с B2B компании в България, които искат да преминат от хаотичен към системен растеж. Особено подходящо за компании с оборот над 100,000 лв. годишно."
          }
        },
        {
          "@type": "Question",
          "name": "Колко време отнема да видя резултати от SEO?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Първите резултати се виждат между 3-6 месеца, но значителни подобрения обикновено се постигат в рамките на 6-12 месеца. SEO е дългосрочна инвестиция, не бърза поправка."
          }
        },
        {
          "@type": "Question",
          "name": "Какво включва SEO Struktor™ системата?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Техническа оптимизация, keyword research, съдържание стратегия, link building, локално SEO, анализ на конкуренцията и месечни отчети с конкретни препоръки."
          }
        },
        {
          "@type": "Question",
          "name": "Как Clientomat™ автоматизира клиентските процеси?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Чрез CRM интеграция, автоматизирани email кампании, lead scoring, автоматично проследяване на взаимодействията и персонализирани комуникации базирани на поведението на клиентите."
          }
        },
        {
          "@type": "Question",
          "name": "Ще се интегрира ли с моята CRM система?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Да, работим с най-популярните CRM системи като HubSpot, Salesforce, Pipedrive и други. Правим и custom интеграции при необходимост."
          }
        },
        {
          "@type": "Question",
          "name": "Какви са вашите цени?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Цените варират в зависимост от обхвата на проекта и спецификите на бизнеса. Започваме с безплатна консултация за оценка на нуждите и изготвяне на персонализирано предложение."
          }
        },
        {
          "@type": "Question",
          "name": "Предлагате ли месечни пакети?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Да, предлагаме както еднократни проекти, така и месечни retainer договори за продължаваща поддръжка и оптимизация на системите."
          }
        },
        {
          "@type": "Question",
          "name": "Как започваме сътрудничеството?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Започваме с 30-минутна безплатна консултация, следвана от анализ на текущото състояние, изготвяне на стратегия и план за изпълнение с ясни етапи и дати."
          }
        },
        {
          "@type": "Question",
          "name": "Колко време отнема имплементацията?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "В зависимост от обхвата: SEO Struktor™ - 2-3 месеца, Clientomat™ - 4-6 седмици, Clickstarter™ - 6-8 седмици. Комплексни проекти могат да отнемат 3-6 месеца."
          }
        }
      ]
    }
