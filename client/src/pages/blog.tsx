...
const blogPosts: BlogPost[] = [
  {
    id: "1",
    title: "Как да създадете предсказуем растеж в компанията си за бизнес клиенти",
    excerpt:
  ...
  {
    id: "6",
    title: "Възвърната инвестиция на маркетинговите системи: Как да измерите истинската стойност",
    excerpt:
