...
const caseStudies = [
  ...
  },
  {
    ...
    challenge: "Компанията нямаше SEO стратегия и беше невидима в Google търсенията. Нуждаеше се от изграждане на авторитет в нишата и система за генериране на продажби.",
    solution: "Разработихме цялостна SEO стратегия с фокус върху нишови ключови думи. Създадохме експертно съдържание и внедрихме Sales Engine™ за автоматизиране на продажбения процес.",
    results: [
  ...
  },
  {
    ...
    challenge: "Залата разчиташе на сарафанно радио и нямаше автоматизирани процеси за задържане на членове. Високо отпадане и липса на предсказуеми приходи.",
    solution: "Внедрихме Clientomat™ система за автоматизирано задържане на членове и препоръчителни програми. Създадохме персонализирани комуникационни потоци за различни типове клиенти.",
    results: [
      ...
      <section className="pt-24 pb-16 bg-gradient-to-br from-[var(--pravdast-dark)] to-[var(--pravdast-dark-gray)]">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Спрете да мечтаете.{" "}
              <span className="text-[var(--pravdast-yellow)]">Вижте фактите</span>
            </motion.h1>
            <motion.p
            ...
            >
              Вместо обещания и теории - конкретни резултати от системи, които работят предвидимо.
            </motion.p>
          </div>
        </div>
      </section>
                    ...
                    <div className="grid lg:grid-cols-2">
                      ...
                      <div className="p-12">
                        <div className="mb-6">
                          ...
                          <p className="text-[var(--pravdast-yellow)] text-lg font-semibold mb-2">{study.tagline}</p>
                        ...
                        {/* Systems Used */}
                        <div className="mb-8">
                          <h4 className="text-sm font-semibold text-gray-400 mb-3">ИЗПОЛЗВАНИ СИСТЕМИ:</h4>
                      ...
                      <div className="bg-gradient-to-br from-[var(--pravdast-dark)] to-[var(--pravdast-medium-gray)] flex items-center justify-center p-12">
                        <div className="text-center">
                          <div className="w-32 h-32 bg-[var(--pravdast-yellow)]/10 rounded-full flex items-center justify-center mb-6 mx-auto">
                            <TrendingUp className="text-[var(--pravdast-yellow)] text-6xl" size={64} />
                          </div>
                          <h3 className="text-xl font-semibold mb-4">{study.company}</h3>
                          <div className="flex justify-center space-x-1">
                            {[1,2,3,4,5].map((star) => (
                              <Star key={star} className="text-[var(--pravdast-yellow)] fill-current" size={20} />
                            ))}
                          </div>
                        </div>
                      </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl font-bold mb-4">Как постигаме тези резултати?</h2>
              ...
              {[
                {
                  step: "01",
                  title: "Диагностика",
                  description: "Анализираме данните и открываме къде точно се губят приходи"
                },
                {
                  step: "02", 
                  title: "Изграждане",
                  description: "Проектираме и внедряваме системата за решаване на проблема"
                },
                {
                  step: "03",
                  title: "Оптимизация", 
                  description: "Следим резултатите и постоянно подобряваме системата"
                }
              ].map((step, index) => (
                <motion.div
                  key={index}
                  ...
                  viewport={{ once: true }}
                >
                  <div className="text-6xl font-bold text-[var(--pravdast-yellow)] mb-4">{step.step}</div>
      ...
      <section className="py-20 bg-[var(--pravdast-yellow)] text-[var(--pravdast-dark)]">
        <div className="container mx-auto px-6 text-center">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Започнете с безплатна диагностика и вижте как можем да постигнем подобни резултати за вашия бизнес.
          </motion.p>
