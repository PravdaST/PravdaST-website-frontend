...
const caseStudies = [
  ...
  },
  {
    ...
    solution:
      "Внедрихме комбинация от SEO Struktor™ за органична видимост, Sales Engine™ за оптимизация на рекламите и Clientomat™ за автоматизация на продажбения процес.",
    results: [
