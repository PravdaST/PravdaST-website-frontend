    ...
    <section className="min-h-screen flex items-center relative overflow-hidden bg-slate-900">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-1 pt-10 sm:pt-0">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            >
              <Link
                ...
                className="group relative inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-black bg-[#ECB629] rounded-lg overflow-hidden transition-all duration-300 hover:bg-[#d4af37] hover:shadow-xl"
              >
                <span className="relative z-10">Безплатна диагностика</span>
                <div className="absolute inset-0 bg-gradient-to-r from-[#ECB629] to-[#d4af37] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </Link>
            </motion.div>
            ...
            >
              <Link
                href="/services"
                className="group relative inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white border-2 border-white/20 rounded-lg overflow-hidden transition-all duration-300 hover:border-[#ECB629] hover:shadow-xl"
              >
                <span className="relative z-10">Научи повече</span>
                <div className="absolute inset-0 bg-[#ECB629]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </Link>
            </motion.div>
          </motion.div>
          ...
          <motion.div
            className="inline-flex items-center gap-2 px-6 py-3 bg-[#ECB629] text-black rounded-full font-semibold"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.4 }}
          >
            <div className="w-2 h-2 bg-black rounded-full animate-pulse"></div>
            <span>Бизнес инженеринг</span>
          </motion.div>
        </div>
      </div>
    </section>
